...
- Update `CHECKPOINT.m` and `REGRESSION.md` whenever appropriate and informe me of any changes to these files
# Other Notes:
...
- Always remember to use use -m when running Python modules like pytest, pip, or venv. For example: `python -m pytest`