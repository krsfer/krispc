...
class TestViews:
    ...
    def test_upload_pdf_view_success(self, client, mocker):
        ...
        response = client.post(reverse('upload_pdf'), {'pdf_file': pdf_file}, follow=True)
    ...
    def test_upload_pdf_invalid_file(self, client):
        ...
        response = client.post(reverse('upload_pdf'), {'pdf_file': text_file}, follow=True)
    ...
    def test_create_events_view(self, client, user, mocker):
        ...
        response = client.post(reverse('create_events', args=[document.id]), {'calendar_id': 'cal-123'})
