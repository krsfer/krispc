(async function () {
    ...
    function initializeMap() {
        ...
        const a = 0;
        const b = window.convertMetersPerSecondToKilometersPerHour(parseFloat(a));
                        ...
                        if (isGeolocating) {
                            ...
                            const marker = contacts_markers.find((marker) => {
                                if (
                                    ...
                                    //.Test if marker.getPopup is defined
                                    if (marker.getPopup()) {
        ...
        geolocate.on("geolocate", function (e) {
            ...
            if (e.coords.speed)
                ...
                speed = window.convertMetersPerSecondToKilometersPerHour(e.coords.speed);
